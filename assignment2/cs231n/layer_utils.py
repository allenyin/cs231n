...
def affine_relu_backward(dout, cache):
    ...
    Inputs:
    - dout: gradient at the output of relu
    - cache: tuple of (fc_cache, relu_cache) from affine_relu_forward
             corresponding to cache for affine and relu layers
    """
...
def affine_batchnorm_relu_forward(x, w, b, gamma, beta, bn_param):
  ...
  Inputs:
  - x: Input to the batchnorm layer (output of affine)
  ...
  Returns a tupe of:
  - out: Output from the ReLU
  - cache: Object to give to the backward pass. A tuple containing:
      - fc_cache: Objects needed for affine_forward
      - norm_cache: Objects needed for batchnorm_backward
      - relu_cache: Objects needed for relu_backward
  """
...
def affine_batchnorm_relu_backward(dout, cache):
  ...
  Inputs:
  - dout: gradient at the output of relu
  - cache: tuple of (fc_cache, norm_cache, relu_cache) from batchnorm_relu_forward

  Outputs, tuple of the following:
  - dx, dw, db: gradient for affine layer
  - dgamma, dbeta: gradient for batchnorm
  """
...
def affine_layernorm_relu_forward(x, w, b, gamma, beta, ln_param):
  ...
  - cache: Object to give to the backward pass. A tuple containing:
      - fc_cache: Objects needed for affine_forward
      - layer_cache: Objects needed for layernorm_backward
      - relu_cache: Objects needed for relu_backward
  """
  fc_out, fc_cache = affine_forward(x, w, b)
...
def affine_layernorm_relu_backward(dout, cache):
  ...
  Inputs:
  - dout: gradient at the output of relu
  - cache: tuple of (fc_cache, norm_cache, relu_cache) from layernorm_relu_forward
